...
export const seasons = mysqlTable("seasons", {
  ...
  currentStage: mysqlEnum("current_stage", ["preparation", "planting", "caring", "harvesting"]).default("preparation"),
...
export const tasks = mysqlTable("tasks", {
  ...
  stage: mysqlEnum("stage", ["preparation", "planting", "caring", "harvesting"]),
