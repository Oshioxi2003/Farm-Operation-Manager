...
import { BookOpen, CheckCircle2, CalendarDays, Filter, X, Search } from "lucide-react";
                        ...
                        <div className="divide-y">
                          {dateLogs.map(log => {
                            ...
                            const stageBadgeConfig: Record<string, { label: string; color: string }> = {
                              preparation: { label: "Chuẩn bị", color: "border-yellow-300 text-yellow-700 dark:border-yellow-700 dark:text-yellow-300" },
