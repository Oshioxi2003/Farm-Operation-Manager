...
export default function WorkLogs() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setOpen(false);
      toast({ title: "Thanh cong", description: "Da ghi nhat ky" });
    },
  });
    ...
    <ScrollArea className="h-full">
      <div className="p-4 md:p-6 space-y-6">
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <div>
            <h1 className="text-2xl font-bold" data-testid="text-page-title">Nhat ky san xuat</h1>
            <p className="text-sm text-muted-foreground mt-1">Ghi chep hoat dong san xuat hang ngay</p>
          </div>
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button data-testid="button-add-log"><Plus className="mr-1 h-4 w-4" /> Ghi nhat ky</Button>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Ghi nhat ky moi</DialogTitle>
              </DialogHeader>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <Select name="seasonId">
                      <SelectTrigger data-testid="select-log-season"><SelectValue placeholder="Chon" /></SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Select name="taskId">
                      <SelectTrigger data-testid="select-log-task"><SelectValue placeholder="Chon" /></SelectTrigger>
                      <SelectContent>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <Select name="userId">
                      <SelectTrigger data-testid="select-log-user"><SelectValue placeholder="Chon" /></SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="hoursWorked">So gio lam</Label>
                ...
                <Button type="submit" className="w-full" disabled={createMutation.isPending} data-testid="button-submit-log">
                  {createMutation.isPending ? "Dang luu..." : "Luu nhat ky"}
                </Button>
              </form>
            </DialogContent>
          </Dialog>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground">Chua co nhat ky nao</p>
          </div>
        )}
      </div>
    </ScrollArea>
